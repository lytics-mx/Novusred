...
class WebsiteProduct(http.Controller):
    ...
    def get_arrival_product(self):
        ...
        """
        return http.Response(template='novusred_template.new_arrivals_dynamic',
    ...
    def get_testimonials(self):
        ...
        """
        return http.Response(template='novusred_template.testimonial',
    ...
    def descubre(self, **kw):
        ...
        """
        return http.request.render('novusred_template.descubre')
    ...
    def home(self, **kw):
        ...
        if is_mobile:
            return http.request.render('novusred_template.xtream_inicio_mobile')
        else:
            return http.request.render('novusred_template.xtream_inicio')
