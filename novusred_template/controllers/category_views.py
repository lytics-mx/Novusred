...
class CategoryController(http.Controller):
    ...
    def home(self):
        return http.request.render('novusred_template.website_category')  
    ...
    def category(self, category_id=None, subcategory_id=None, brand_id=None, 
        ...
        return request.render('novusred_template.website_subcategory', values)
    ...
    def category_search(self, search=None, **kwargs):
        ...
        return request.render('novusred_template.category_search', values)
