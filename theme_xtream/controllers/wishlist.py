...
class WishlistController(http.Controller):
    @http.route('/tienda/wishlist', type='http', auth='public', website=True)
    ...
    @http.route('/tienda/wishlist/clear', type='http', auth='public', methods=['POST'], website=True)
    def clear_wishlist(self):
        ...
        return request.redirect('/tienda/wishlist')
    
    @http.route('/tienda/wishlist/remove/<int:item_id>', type='http', auth='public', methods=['POST'], website=True)
