...
class CategoryController(http.Controller):
    ...
    def category(self, category_id=None, subcategory_id=None, brand_id=None, 
        ...
        if category_id:
            ...
            subcategories = selected_category.child_ids
        else:
        ...
        if category_id or subcategory_id:
            ...
            available_brands = brand_products.mapped('brand_id')
        else:
    ...
    def get_brands(self, category_id=None, subcategory_id=None):
        ...
        result = []
        for brand in brands:
            brand_count = len(products.filtered(lambda p: p.brand_id.id == brand.id))
            result.append({
                'id': brand.id,
                'name': brand.name,
